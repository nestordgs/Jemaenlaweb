...
@section('content')
    <div class="raleway">
      ...
      <section class="mobile visible-xs visible-sm  bg-about" style="background-image: url( {{ get_theme_mod('background_image_about') }} )">
          <div></div>
      </section>
      <section class="desktop bg-about" style="background-image: url( {{ get_theme_mod('background_image_about') }} )">
